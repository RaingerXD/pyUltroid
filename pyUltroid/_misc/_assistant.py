...
IN_BTTS = [
    [
        Button.url(
            "Repository",
            url="https://github.com/RaingerXD/UltroidX",
        ),
        Button.url("Support", url="https://t.me/raingersupport"),
    ]
]
            ...
            if owner and event.sender_id not in owner_and_sudos():
                res = [
                    await event.builder.article(
                        ...
                        url="https://t.me/raingersupport",
                        description="(c) rainger support",
                        text=MSG,
                    ...
                    await event.answer(
                        [
                            await event.builder.article(
                                ...
                                text=error_text(),
                                buttons=Button.url(
                                    "Report", "https://t.me/raingersupport"
                                ),
                            )
                        ]
                    )
